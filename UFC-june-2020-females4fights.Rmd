...
```{r}
write.csv(Table8, 'Nunez4Fights_addedFeatures.csv', row.names=F)
...
It would be best to redo the data imported and modify it to have a key word like **'continued holding'**. There are some notes of the **'holding starts'** or **'holding ends'**. 
